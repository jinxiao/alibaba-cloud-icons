...
const summary = JSON.parse(fs.readFileSync(path.join(root, 'dist/summary.json'), 'utf8'));
const script = fs.readFileSync(path.join(root, 'dist/plugins/alibaba-cloud.js'), 'utf8');
